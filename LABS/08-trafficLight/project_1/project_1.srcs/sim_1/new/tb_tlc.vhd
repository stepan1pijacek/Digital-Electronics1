...
entity tlc is
    port(
        clk         : in  std_logic;
        reset       : in  std_logic;
        south_sensor: in  std_logic;
        west_sensor : in  std_logic; 
...
architecture Behavioral of tlc is
    ...
    -- Define the states
    type t_state is (STOP,      --after reset
                     WEST_GO,
                     WEST_WAIT,
                     SOUTH_GO,
                     SOUTH_WAIT);
    ...
    constant c_DELAY_3SEC : unsigned(5 - 1 downto 0) := b"0_1010";
    constant c_DELAY_2SEC : unsigned(5 - 1 downto 0) := b"0_1000";
    constant c_DELAY_05SEC : unsigned(5 - 1 downto 0) := b"0_0100";
